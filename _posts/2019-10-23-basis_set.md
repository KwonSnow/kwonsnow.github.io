...
* Formal Shell Charge는 임의로 정해도 되는 듯. Check O in NiO vs CoO case [J. Phys. Chem. Lett. 2016, 7, 1198](https://pubs.acs.org/doi/10.1021/acs.jpclett.5b02870). 다만, Neutral charge를 만족하기 위해서는 다른 element의 Charge도 바꿔야 함. 뭐든, 수렴이 잘 되는 쪽을 선택하면 될 듯.
