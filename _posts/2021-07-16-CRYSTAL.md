...
To get the BSSE estimation from the counterpoise correction method, we need four additional single point calculation with the geometry of compound AB denoted by *.
