...
The COOP results from multiplying the DOS by the overlap population, and it adds an additional dimension—the bonding information. The antibonding (out-of-phase) combination with a negative overlap population:
