...
여기서 α<sub>1</sub>과 α<sub>2</sub>는 functional에 따라 조정이 가능한 파라미터이고, DFT-D3(0)에서처럼 s<sub>6</sub> 일반적으로 1 로 고정되고, s<sub>8</sub>는 사용하는 functional에 따라 최적화 된 값이다. __DFT-D3(BJ)는 일반적으로 DFT-D3(0)에 비해 성능이 우수하다.__ [J. Comput. Chem. 2011, 32, 1456](https://doi.org/10.1002/jcc.21759)
